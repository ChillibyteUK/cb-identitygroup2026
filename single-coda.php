<?php
/**
 * Template for displaying single posts — coda's own real design.
 *
 * coda's real category taxonomy is press/insights/perspectives, not
 * idtravel's news/people/tmc (the shared single.php this was forked from).
 * Included from single.php when cb_site_template_suffix() === 'coda'.
 *
