...
function cb_filter_editor_theme_json( $theme_json ) {
	...
	$palettes = array(
		'identity' => array(
			...
			array( 'slug' => 'lime-700', 'name' => 'Lime 700', 'color' => '#6bb600' ),
			array( 'slug' => 'lime-200', 'name' => 'Lime 200', 'color' => '#ddfbb2' ),
			array( 'slug' => 'green-400', 'name' => 'Green 400', 'color' => '#B8FF52' ),
			...
			array( 'slug' => 'neutral-100', 'name' => 'Neutral 100', 'color' => '#f8f7f0' ),
			array( 'slug' => 'neutral-200', 'name' => 'Neutral 200', 'color' => '#ebe9e1' ),
			array( 'slug' => 'neutral-300', 'name' => 'Neutral 300', 'color' => '#dddcd2' ),
			array( 'slug' => 'neutral-400', 'name' => 'Neutral 400', 'color' => '#c9c7bc' ),
			array( 'slug' => 'neutral-500', 'name' => 'Neutral 500', 'color' => '#aeada1' ),
			array( 'slug' => 'neutral-600', 'name' => 'Neutral 600', 'color' => '#939287' ),
			array( 'slug' => 'neutral-700', 'name' => 'Neutral 700', 'color' => '#77766c' ),
			array( 'slug' => 'neutral-800', 'name' => 'Neutral 800', 'color' => '#5e5d55' ),
			array( 'slug' => 'neutral-900', 'name' => 'Neutral 900', 'color' => '#505049' ),
			array( 'slug' => 'neutral-1000', 'name' => 'Neutral 1000', 'color' => '#363531' ),
			array( 'slug' => 'neutral-1100', 'name' => 'Neutral 1100', 'color' => '#22211e' ),
		...
		'idtravel' => array(
			...
			array( 'slug' => 'lime-700', 'name' => 'Lime 700', 'color' => '#cc1939' ),
			array( 'slug' => 'lime-200', 'name' => 'Lime 200', 'color' => '#ffb8c6' ),
			array( 'slug' => 'green-400', 'name' => 'Green 400', 'color' => '#f66f88' ),
			...
			array( 'slug' => 'neutral-1100', 'name' => 'Neutral 1100', 'color' => '#040013' ),
