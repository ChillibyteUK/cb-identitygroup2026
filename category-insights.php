<?php
/**
 * Template for displaying the "Insights" category archive — identity's own
 * real design. WordPress's template hierarchy picks this up automatically
 * for the "insights" category slug (category-{slug}.php); the shared
 * theme otherwise falls back to the generic archive template, which is
 * what idtravel/coda still get since they don't have this category.
 *
