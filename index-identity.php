<?php
/**
 * Template for displaying the blog index page — identity's own real design.
 *
 * identity's news page is a genuinely different layout from
 * idtravel's/coda's (the shared index.php): two separate, capped sections
 * (Insights + Perspectives, then Press) rather than one unbounded list.
 * Included from index.php when cb_site_template_suffix() === 'identity'.
 *
